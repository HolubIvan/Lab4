...
public class MovieRentalTest {
    ...
    public void testGetTitle() {
        Assert.assertEquals("The Man Who Knew Too Much", theManWhoKnewTooMuch.get_title());
    }


    @Test
    public void testGetDaysRented() {
        Assert.assertEquals(2, new MovieRental(theManWhoKnewTooMuch, 2).getDaysRented());
    }

    @Test
    public void testGetMovie() {
        Assert.assertEquals(theManWhoKnewTooMuch, new MovieRental(theManWhoKnewTooMuch, 2).getMovie());
    }

    @Test
    public void testGetName() {
        String name = "John Doe";
        Assert.assertEquals(name, new Customer(name)._name);
    }
    ...
    public void testStatementRegularMovieOnly() {
        ...
        Assert.assertEquals(expectedResult, johnDoe.statement());
    }
    ...
    public void testStatementChildrensMovieOnly() {
        ...
        String expectedResult = "Rental Record for Johnny Doe, Jr.\n" +
                                ...
                                "Amount owed is 5.75\n" +
                                "You earned 3 frequent renter points";
        Assert.assertEquals(expectedResult, johnDoeJr.statement());
    }
    ...
    public void testStatementNewReleaseOnly() {
        ...
        Assert.assertEquals(expectedResult, janeDoe.statement());
    }
}